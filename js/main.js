...
$(document).ready(function() {
    ...
    tlText.to("#animate-text", textChangeDuration, { text: "EXPLORATION" })
        .to("#animate-text", textChangeDuration, { text: "DISCOVERY" }, '+=2')
        .to("#animate-text", textChangeDuration, { text: "WILDERNESS" }, '+=2')
        .to("#animate-text", textChangeDuration, { text: "EXPEDITION" }, '+=2')
        .to("#animate-text", textChangeDuration, { text: "LUXURY" }, '+=2')
        .to("#animate-text", textChangeDuration, { text: "EXHILARATION" }, '+=2')
